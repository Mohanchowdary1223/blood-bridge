...
import { Search, Share2, Droplets, User, CalendarClock, ArrowLeft, Copy, Instagram, Mail, Check, BookOpen } from 'lucide-react';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 ">
            ...
            <Card className="group transition-all duration-300 border-0 hover:-translate-y-2">
              <CardHeader className="text-center pb-4">
                ...
                <CardDescription className="text-muted-foreground">
                  Learn health maintenance and wellness tips
                </CardDescription>
              </CardHeader>
              <CardContent className="pt-0">
                <Button
