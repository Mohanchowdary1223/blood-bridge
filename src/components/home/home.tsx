...
import { Search, BarChart3, Droplets, Share2, ArrowRight, ArrowLeft, Copy, Instagram, Mail, Check, Users, Heart, TrendingUp, ArrowUp } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50 pt-8">
      ...
      >
        <Button
          onClick={handleGuideClick}
          size="icon"
          className="fixed bottom-16 right-4 w-10 h-10 rounded-full hover:scale-110 transition-all duration-300 z-50 bg-primary hover:bg-primary/80 cursor-pointer"
